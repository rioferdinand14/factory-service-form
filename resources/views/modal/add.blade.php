<!-- MODAL ADD-->
<div class="modal fade" id="TaskModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addTask" data-action="{{ route('projects.create-data') }}" method="POST" autocomplete="off"
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            @if (Auth::user()->detail_user->type_user->name === 'Administrator' ||
                                ...
                                <div class="col-sm-5 offset-sm-2 col-md-6 offset-md-0">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control w-100" id="category_project"
                            ...
                            @elseif (Auth::user()->detail_user->type_user->name === 'Operation Factory')
                                <div class="col-sm-5 col-md-6">
                                    <input type="hidden" class="form-control datepicker " id="datepicker"
                                        name="input_date" />
                                    <div class="mb-3">
                                        <label for="project" class="align-items-start">Project:</label>
                                        <input type="text" class="form-control w-100" name="nama_project">
