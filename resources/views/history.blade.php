                                                ...
                                                <td>
                                                    <div class="table-data-feature" id="editContainer">             
                                                            @if ($item->status === 'Done')
                                                                    ...
                                                                    <button class="item permanent-delete-btn" data-toggle="tooltip" data-project-id="{{ $item->id }}" data-placement="top" title="Delete">
                                                                        <i class="zmdi zmdi-delete"></i>
                                                                    </button>                                                                
                                                            @elseif ($item->deleted_at)                                                                
                                                                    <a href="{{ route('projects.restore', $item->id) }}" onclick="event.preventDefault(); document.getElementById('restore-form-{{ $item->id }}').submit();" class="item" title="Restore"><i class="fas fa-trash-restore"></i></a>
                                                                    <button class="item permanent-delete-btn" data-toggle="tooltip" data-project-id="{{ $item->id }}" data-placement="top" title="Delete">
                                                                        <i class="zmdi zmdi-delete"></i>
                                                                    </button> 
                                                            @else
                                                            ...
                                                            @endif                                                                               
                                                            <form id="restore-form-{{ $item->id }}" action="{{ route('projects.restore', $item->id) }}" method="POST" style="display: none;">
                                                                @csrf
                                                                @method('PUT')
                                                            </form>
                                                    </div>
